...
EXECUTE IMMEDIATE FROM '@SNOWFLAKE_EXAMPLE.GIT_REPOS.SFE_DEMOS_REPO/branches/main/demo-music-label-marketing-analytics/sql/03_transformations/02_dynamic_tables_facts.sql';
EXECUTE IMMEDIATE FROM '@SNOWFLAKE_EXAMPLE.GIT_REPOS.SFE_DEMOS_REPO/branches/main/demo-music-label-marketing-analytics/sql/03_transformations/03_ai_enrichment.sql';
