...
SELECT
  ...
  CASE
    ...
    AND (SELECT COUNT(*) FROM RAW_ORDERS) = (SELECT COUNT(*) FROM CURRENT_ORDERS)
    AND (SELECT COUNT(*) FROM RAW_ORDERS) = (SELECT COUNT(DISTINCT ORDER_ID) FROM RAW_ORDERS)
    AND (SELECT COUNT(*) FROM CURRENT_ORDERS) = (SELECT COUNT(DISTINCT ORDER_ID) FROM CURRENT_ORDERS)
    THEN 'PASS'
    ELSE 'FAIL'
