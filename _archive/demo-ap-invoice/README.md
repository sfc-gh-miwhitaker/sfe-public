...
> DEMONSTRATION PROJECT - EXPIRES: 2026-08-12
> This demo uses Snowflake features current as of May 2026.
...
**Created:** 2026-04-08 | **Expires:** 2026-08-12 | **Status:** ACTIVE
...
- **AI_EXTRACT** - Structured field extraction from PDF invoices with per-field confidence scores
- **AI_CLASSIFY** - GL account code suggestion from line item descriptions with category-aware prompting
- **Validation scoring** - Weighted composite from AI_EXTRACT per-field confidence plus vendor matching
...
- **Cortex Analyst** - Natural language analytics with verified queries for high accuracy
