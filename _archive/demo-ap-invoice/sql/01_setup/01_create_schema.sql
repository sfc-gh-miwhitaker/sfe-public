...
CREATE STAGE IF NOT EXISTS RAW_INVOICE_STAGE
  ...
  COMMENT = 'DEMO: Landing zone for PDF invoices (Expires: 2026-08-12)';
...
) COMMENT = 'DEMO: Vendor master for name resolution (Expires: 2026-08-12)';
...
) COMMENT = 'DEMO: GL code taxonomy for classification (Expires: 2026-08-12)';
...
) COMMENT = 'DEMO: Extracted invoice headers with validation scores (Expires: 2026-08-12)';
...
) COMMENT = 'DEMO: Invoice line items with GL classification (Expires: 2026-08-12)';
...
CREATE TABLE IF NOT EXISTS REVIEW_QUEUE (
    ...
    RESOLUTION          VARCHAR,
    NOTES               VARCHAR
) COMMENT = 'DEMO: Human-in-the-loop review queue (Expires: 2026-08-12)';
...
) COMMENT = 'DEMO: Complete audit trail for every AI and human decision (Expires: 2026-08-12)';
