...
- Validation scoring uses AI_EXTRACT per-field confidence (`scores => TRUE`, GA since Mar 2026). Score is a weighted sum of per-field extraction confidence plus a vendor master matching bonus.
