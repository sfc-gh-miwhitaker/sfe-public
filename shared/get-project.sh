...
echo ""
echo "  # Open with your AI assistant:"
echo "  cortex                    # Cortex Code"
echo "  claude                    # Claude Code"
echo "  # or open the folder in Cursor"
echo ""
echo "  # Or deploy directly in Snowsight:"
echo "  # Open deploy_all.sql in a Snowsight worksheet and Run All"
