...
VALUES
    (1, 'Jade Hollow Live — Nashville',     'The Ryman Auditorium',       'Nashville',   DATEADD('day',  28, CURRENT_DATE()), 2362,  35.00),
    (2, 'Jade Hollow Live — Austin',        'Stubb''s Waller Creek',      'Austin',      DATEADD('day',  42, CURRENT_DATE()), 2750,  32.00),
    (3, 'Jade Hollow Live — Chicago',       'Schubas Tavern',             'Chicago',     DATEADD('day',  56, CURRENT_DATE()), 400,   28.00),
    (4, 'Jade Hollow Live — Los Angeles',   'El Rey Theatre',             'Los Angeles', DATEADD('day',  70, CURRENT_DATE()), 770,   40.00),
    (5, 'Jade Hollow Live — New York',      'Bowery Ballroom',            'New York',    DATEADD('day',  84, CURRENT_DATE()), 575,   45.00);
