...
Table refresh health. Write `/workspace/shopify/monthly-<current-date>.md` with changes,
deprecations, risks, and a controlled CoCo Desktop upgrade prompt. Never modify production.
