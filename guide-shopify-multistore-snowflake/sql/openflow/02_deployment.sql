/*
  guide-shopify-multistore-snowflake — sql/openflow/02_deployment.sql
  ...
  COST NOTE
    ...
    exists -- even with zero runtimes running. Suspending a runtime does not
    stop it; only DROP OPENFLOW DEPLOYMENT does. See 07_monitoring.sql query A1.
