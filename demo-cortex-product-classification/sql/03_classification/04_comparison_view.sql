...
CREATE OR REPLACE VIEW CLASSIFICATION_COMPARISON
  COMMENT = 'DEMO: Side-by-side classification accuracy across all four approaches (Expires: 2026-07-01)'
AS
SELECT
    p.product_id,
    p.product_name,
...
CREATE OR REPLACE VIEW ACCURACY_SUMMARY
  COMMENT = 'DEMO: Aggregated accuracy metrics by approach and market (Expires: 2026-07-01)'
AS
SELECT
    market_code,
    language_code,
