...
----------------------------------------------------------------------
-- Pattern 6: Extract with per-field confidence scores (GA Mar 2026)
-- Returns scoring object alongside response for threshold-based routing
----------------------------------------------------------------------
-- SELECT AI_EXTRACT(
--     file => TO_FILE('@RAW_INVOICE_STAGE', 'your_invoice.pdf'),
--     responseFormat => {
...
--     scores => TRUE
-- );
-- Returns: { "response": {...}, "scoring": {"scores": {"vendor_name": {"score": 0.95}, ...}}, "error": null }

----------------------------------------------------------------------
-- Pattern 7: Enhanced OCR for poor-quality scans (scale_factor)
-- Use for large-format docs or scans with small text / dense layouts
----------------------------------------------------------------------
-- SELECT AI_EXTRACT(
--     file => TO_FILE('@RAW_INVOICE_STAGE', 'faded_scan.pdf'),
--     responseFormat => {
