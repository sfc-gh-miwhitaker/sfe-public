...
CREATE OR REPLACE TAG DATA_DOMAIN
  ...
  COMMENT = 'DEMO: Business domain classification for tables and columns (Expires: 2026-11-06)';

CREATE OR REPLACE TAG DATA_SENSITIVITY
  ALLOWED_VALUES 'PUBLIC', 'INTERNAL', 'CONFIDENTIAL'
  COMMENT = 'DEMO: Column-level sensitivity classification (Expires: 2026-11-06)';

CREATE OR REPLACE TAG DATA_QUALITY_TIER
  ALLOWED_VALUES 'RAW', 'VALIDATED', 'CURATED'
  COMMENT = 'DEMO: Data quality tier for tables and views (Expires: 2026-11-06)';
...
RETURNS STRING ->
  CASE
    ...
    ELSE val
  END
COMMENT = 'DEMO: Masks VARCHAR columns tagged CONFIDENTIAL for non-admin roles (Expires: 2026-11-06)';
...
CREATE OR REPLACE VIEW V_TAG_GOVERNANCE_SUMMARY
  COMMENT = 'DEMO: All tag assignments across DATA_QUALITY objects (Expires: 2026-11-06)'
AS
WITH table_tags AS (
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.RAW_ATHLETE_PERFORMANCE', 'TABLE'))
  UNION ALL
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.RAW_FAN_ENGAGEMENT', 'TABLE'))
  UNION ALL
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.STG_DATA_QUALITY_METRICS', 'TABLE'))
),
view_tags AS (
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.V_ATHLETE_PERFORMANCE', 'TABLE'))
  UNION ALL
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.V_FAN_ENGAGEMENT', 'TABLE'))
),
column_tags AS (
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.RAW_ATHLETE_PERFORMANCE.ATHLETE_ID', 'COLUMN'))
  UNION ALL
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.RAW_FAN_ENGAGEMENT.FAN_ID', 'COLUMN'))
  UNION ALL
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.RAW_ATHLETE_PERFORMANCE.METRIC_VALUE', 'COLUMN'))
  UNION ALL
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.RAW_FAN_ENGAGEMENT.SESSION_DURATION', 'COLUMN'))
  UNION ALL
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.RAW_ATHLETE_PERFORMANCE.SPORT', 'COLUMN'))
  UNION ALL
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.RAW_ATHLETE_PERFORMANCE.NGB_CODE', 'COLUMN'))
  UNION ALL
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.RAW_ATHLETE_PERFORMANCE.DATA_SOURCE', 'COLUMN'))
  UNION ALL
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.RAW_FAN_ENGAGEMENT.CHANNEL', 'COLUMN'))
  UNION ALL
  SELECT TAG_NAME, TAG_VALUE, OBJECT_NAME, DOMAIN, COLUMN_NAME, LEVEL FROM TABLE(INFORMATION_SCHEMA.TAG_REFERENCES('DATA_QUALITY.RAW_FAN_ENGAGEMENT.EVENT_TYPE', 'COLUMN'))
)
SELECT
  TAG_NAME,
  TAG_VALUE,
