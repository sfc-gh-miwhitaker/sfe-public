...
CREATE OR REPLACE STREAM SNOWFLAKE_EXAMPLE.DATA_QUALITY.RAW_ATHLETE_PERFORMANCE_STREAM
  ...
  COMMENT = 'DEMO: Stream for athlete performance changes | Author: SE Community | Expires: 2026-11-06';
...
CREATE OR REPLACE STREAM SNOWFLAKE_EXAMPLE.DATA_QUALITY.RAW_FAN_ENGAGEMENT_STREAM
  ...
  COMMENT = 'DEMO: Stream for fan engagement changes | Author: SE Community | Expires: 2026-11-06';
